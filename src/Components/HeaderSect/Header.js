...
const Header = () => {
    ...
    return (
        <>
            <header className='aeHeader sticky-top'>
                            ...
                            <div className="container-fluid">
                                ...
                                <div className="offcanvas offcanvas-start" data-bs-scroll="false" data-bs-backdrop="false" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                                    <div className="offcanvas-header">
                                        <button type="button" className='CloseNav' data-bs-dismiss="offcanvas" aria-label="Close">
                                ...
                                <div>
                                    <NavLink to="/"><img src={Logo1} className='NavLogo' alt='Logo' /></NavLink>
                                </div>
                                <div>
                                    <a href="#Footer-Enquiry"><FontAwesomeIcon className='EnquireIcon' icon={faPhone} /></a>
                                </div>
                            </div>
                        </nav>
                    </div>
