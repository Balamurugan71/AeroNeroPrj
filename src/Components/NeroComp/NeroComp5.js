...
import "./NeroComp5.css"

const NeroComp5 = ({ capacity, material, usage, filtration, powerSupply,
    netWeight, powerConsumption, size, tankCapacity, noiseLevel
}) => {
    return (
        <>
